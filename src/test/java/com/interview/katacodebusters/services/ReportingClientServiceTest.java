...
@SpringBootTest
public class ReportingClientServiceTest {
    ...
    @Test
    public void test_compute_client_prices_map() throws IOException {
        try (MockedStatic<ForexDAO> forexDao = Mockito.mockStatic(ForexDAO.class);
            ...
            Map<String, Double> expected = Map.of("C1", 300.0, "C2", 360.0);
            var actual = ReportingClientService.computeClientPricesMap(EXCHANGE_RATE_MAP, LIST_PRICES);
